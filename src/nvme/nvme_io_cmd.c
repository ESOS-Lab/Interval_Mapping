...
void handle_nvme_io_read(unsigned int cmdSlotTag, NVME_IO_COMMAND *nvmeIOCmd)
{
    ...
    // if (startLba[0] < storageCapacity_L_fake && (startLba[1] < STORAGE_CAPACITY_H || startLba[1] == 0) ) {
        // xil_printf("LBA %d exceeding physical limit: %d\n", startLba[0], storageCapacity_L_fake);
    // }
...
void handle_nvme_io_dataset_management(unsigned int cmdSlotTag, NVME_IO_COMMAND *nvmeIOCmd)
{
	...
	char dmaGet[BYTES_PER_NVME_BLOCK];
